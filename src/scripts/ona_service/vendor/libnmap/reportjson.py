...
import json
from .objects import NmapHost, NmapService, NmapReport
from .objects.os import NmapOSFingerprint, NmapOSMatch, NmapOSClass
from .objects.os import CPE, OSFPPortUsed
